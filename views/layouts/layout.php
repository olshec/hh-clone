    ...
    <header class="header">
        <div class="container">
            <nav class="navbar navigation">
                <a class="navbar-brand" href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/logo.svg" alt="Logo">
                </a>
        ...
        <div class="container">
            <div class="header-search__wrap">
                <form class="header-search__form">
                    <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/dark-search.svg" alt="search"
            ...
            <div class="footer__wrap">
                <div class="row">
                    <div class="footer__col footer__policy col-lg-3 col-md-12 p-rel">
                        <a class="footer__logo" href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/logo.svg" alt="Logo"></a>
                        <div class="footer__soc-icon">
                            <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/vk.png" alt="vk"></a>
                            <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/facebook.png" alt="facebook"></a>
                            <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/twitter.png" alt="twitter"></a>
                            <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/images/instagram.png" alt="instagram"></a>
                        </div>
