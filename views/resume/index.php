                    ...
                    <div class="vakancy-page-filter-block__row mb24">
                        ...
                        <div class="profile-info">
                            <div class="form-check d-flex">
                                <input type="checkbox" class="form-check-input" id="experienceCheck1" value="1">
                            ...
                            <div class="form-check d-flex">
                                <input type="checkbox" class="form-check-input" id="experienceCheck2" value="2">
                            ...
                            <div class="form-check d-flex">
                                <input type="checkbox" class="form-check-input" id="experienceCheck3" value="3">
                            ...
                            <div class="form-check d-flex">
                                <input type="checkbox" class="form-check-input" id="experienceCheck4" value="4">
