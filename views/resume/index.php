            ...
            <div class="row">
                <div class="col-lg-9 desctop-992-pr-16">
                    <div class="d-flex align-items-center flex-wrap mb8">
                        <span class="paragraph mr16">Найдено <?= $countResumes;?> резюме</span>
...
<!--                     </ul> -->
                ...
                <div class="col-lg-3 desctop-992-pl-16 d-flex flex-column vakancy-page-filter-block vakancy-page-filter-block-dnone">
                    ...
                    <div class="signin-modal__switch-btns-wrap resume-list__switch-btns-wrap mb16">
                        <a href="<?= $addressServer ?>resume#" id="serch-gender-all"    class="signin-modal__switch-btn    <?= $gender == 'all'?  'active':'' ?>">Все</a>
                        <a href="<?= $addressServer ?>resume#" id="serch-gender-male"   class="signin-modal__switch-btn    <?= $gender == 'male'?  'active':'' ?>">Мужчины</a>
                        <a href="<?= $addressServer ?>resume#" id="serch-gender-female" class="signin-modal__switch-btn    <?= $gender == 'female'?'active':'' ?>">Женщины</a>
                    </div>
