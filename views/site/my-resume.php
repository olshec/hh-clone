        ...
        <div class="container">
            <div class="col-lg-9">
                <div class="main-title mb32 mt50 d-flex justify-content-between align-items-center">Мои резюме
                    <a href="<?= \yii\helpers\Url::to(['/']) ?>site/add-resume" class="link-orange-btn orange-btn my-vacancies-add-btn">Добавить резюме</a><a
                                    ...
                                    <div class="row">
                                        <div class="my-resume-dropdown dropdown show mb8">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="<?= \yii\helpers\Url::to(['/']) ?>site/edit-resume">Редактировать</a>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-wrap mobile-mb12">
                                                <a class="mr16" href="<?= \yii\helpers\Url::to(['/']) ?>site/resume-view">Открыть</a>
                                            </div>
